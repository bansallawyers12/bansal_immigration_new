...
class EmployeeSponsoredPagesSeeder extends Seeder
{
    /**
    ...
    {
        // Main Employee Sponsored Index Page
        Page::firstOrCreate([
            'category' => 'employee-sponsored',
            'slug' => 'employee-sponsored'
        ], [
            'title' => 'Employee Sponsored Visas',
            'slug' => 'employee-sponsored',
            'content' => '<h2>Employee Sponsored Visas</h2><p>Australia offers various employee-sponsored visa options for skilled workers who have an Australian employer willing to sponsor them. These visas provide pathways to both temporary and permanent residence in Australia.</p><h3>Types of Employee Sponsored Visas</h3><ul><li><strong>Temporary Visas:</strong> TSS Visa (482), DAMA, Skilled Regional (494)</li><li><strong>Permanent Visas:</strong> ENS 186, Distinguished Talent (124/858)</li><li><strong>Global Talent:</strong> GTI and GTES Programs</li></ul>',
            'excerpt' => 'Comprehensive employee-sponsored visa services for skilled workers with Australian employer sponsorship.',
            'template' => 'pages.employee-sponsored',
            'category' => 'employee-sponsored',
            'meta_title' => 'Employee Sponsored Visas Australia - Employer Nomination Services',
            'meta_description' => 'Expert employee-sponsored visa services including TSS 482, ENS 186, and Global Talent programs for skilled workers with Australian employer sponsorship.',
            'status' => true,
            'featured' => true,
            'order' => 1
        ]);
        ...
        $this->command->info('✅ Created employee-sponsored pages');
        $this->command->info('📊 Total employee-sponsored pages: ' . Page::where('category', 'employee-sponsored')->count());
    }
}
