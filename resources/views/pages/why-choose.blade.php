...
@section('seoinfo')
    <title>Why Choose Us - Bansal Immigration Consultants</title>
    <meta name="description" content="Discover why Bansal Immigration Consultants is the trusted choice for Australian immigration services. MARA registered agents with proven success.">
@endsection
...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg p-8 text-center text-white">
        <h2 class="text-3xl font-bold mb-4">Ready to Start Your Immigration Journey?</h2>
        <p class="text-xl mb-8">Let our experienced team guide you to success.</p>
