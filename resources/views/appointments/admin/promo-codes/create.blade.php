...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Create a new discount code for appointments</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                ...
                                <input type="number" name="minimum_amount" id="minimum_amount" value="{{ old('minimum_amount', 0) }}" 
                            ...
                            <div class="mt-1">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="is_one_time_use" value="1" 
                                           {{ old('is_one_time_use', false) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="applicable_enquiry_types[]" value="{{ $key }}" 
                                       {{ in_array($key, old('applicable_enquiry_types', [])) ? 'checked' : '' }}
                                       class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
