...
@section('seoinfo')
    <title>Mission & Vision - Bansal Immigration Consultants</title>
    <meta name="description" content="Learn about Bansal Immigration Consultants' mission and vision to help people achieve their Australian immigration dreams.">
@endsection
...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="text-center">
        <h2 class="text-3xl font-bold text-gray-900 mb-4">Join Our Success Story</h2>
        <p class="text-lg text-gray-600 mb-8">Let us help you achieve your Australian immigration goals with our proven expertise and commitment to excellence.</p>
