...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mt-16 bg-white rounded-lg shadow-lg p-8">
        <h3 class="text-2xl font-bold text-gray-900 mb-4 text-center">Ready to Become an Australian Citizen?</h3>
        <p class="text-gray-600 mb-6 text-center">Let us guide you through your citizenship application process step by step. Send us your details for personalized citizenship assistance.</p>
