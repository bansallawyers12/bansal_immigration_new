...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600">Update success story information</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <form method="POST" action="{{ route('admin.success-stories.update', $successStory) }}" class="space-y-6" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $successStory->title) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="client_name" id="client_name" value="{{ old('client_name', $successStory->client_name) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="client_country" id="client_country" value="{{ old('client_country', $successStory->client_country) }}"
                    ...
                    <div>
                        ...
                        <select name="visa_type" id="visa_type" required
                            ...
                            @foreach($visaTypes as $visaType)
                                <option value="{{ $visaType }}" {{ old('visa_type', $successStory->visa_type) === $visaType ? 'selected' : '' }}>
                                    {{ $visaType }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="date" name="success_date" id="success_date" 
                               value="{{ old('success_date', $successStory->success_date ? $successStory->success_date->format('Y-m-d') : '') }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="order" id="order" value="{{ old('order', $successStory->order) }}" min="0"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3" required
                                  ...
                                  placeholder="Enter a brief excerpt of the success story">{{ old('excerpt', $successStory->excerpt) }}</textarea>
                        @error('excerpt')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="10" required
                              ...
                              placeholder="Write the full success story here...">{{ old('content', $successStory->content) }}</textarea>
                    @error('content')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <img src="{{ asset('storage/' . $successStory->image) }}" alt="{{ $successStory->image_alt }}" class="h-32 w-32 object-cover rounded-lg border">
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ $successStory->image ? 'Replace Image' : 'Featured Image' }}
                        </label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="image_alt" id="image_alt" value="{{ old('image_alt', $successStory->image_alt) }}"
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $successStory->meta_title) }}"
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3"
                                  ...
                                  placeholder="Brief description for search engines">{{ old('meta_description', $successStory->meta_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', $successStory->meta_keywords) }}"
            ...
            <div class="pb-6">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="status" id="status" value="1" {{ old('status', $successStory->status) ? 'checked' : '' }}
                    ...
                    <!-- Featured -->
                    <div class="flex items-center">
                        <input type="checkbox" name="featured" id="featured" value="1" {{ old('featured', $successStory->featured) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
