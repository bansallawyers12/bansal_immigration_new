                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                @foreach($categories as $category)
                                    ...
                                    @if($category->subcategories->count() > 0)
                                        @foreach($category->subcategories as $subcategory)
                                            <option value="{{ $subcategory->id }}" {{ old('parent_category') == $subcategory->id ? 'selected' : '' }}>
                                                &nbsp;&nbsp;{{ $subcategory->name }}
                                            </option>
                                        @endforeach
                                    @endif
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="short_description" id="short_description" rows="3" required
                                  ...
                                  placeholder="Enter a brief description of the blog post">{{ old('short_description') }}</textarea>
