...
@section('seoinfo')
    <title>Privacy Policy - Bansal Immigration Consultants</title>
    <meta name="description" content="Read our privacy policy to understand how Bansal Immigration Consultants collects, uses, and protects your personal information.">
@endsection
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="prose max-w-none">
            <h2>Introduction</h2>
            <p>Bansal Immigration Consultants ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.</p>
            ...
            <p>We may automatically collect certain information about your device and usage patterns:</p>
            <ul>
            ...
            <ul>
                <li>Provide immigration consultation and visa application services</li>
                <li>Communicate with you about your case and our services</li>
                <li>Process payments and maintain records</li>
                <li>Comply with legal and regulatory requirements</li>
                <li>Improve our website and services</li>
                <li>Send you relevant information and updates (with your consent)</li>
            </ul>

            <h2>Information Sharing and Disclosure</h2>
            <p>We may share your information in the following circumstances:</p>
            <ul>
                <li><strong>Government Authorities:</strong> As required for visa applications and legal compliance</li>
            ...
            <p>We retain your personal information for as long as necessary to provide our services and comply with legal obligations. Immigration records are typically retained for at least 7 years after case completion.</p>
            ...
            <div class="bg-gray-50 p-4 rounded-lg mt-4">
                <p><strong>Bansal Immigration Consultants</strong><br>
                Level 8/278 Collins Street<br>
                Melbourne VIC 3000, Australia<br>
                Phone: +61 3 9602 1330<br>
                Email: info@bansalimmigration.com.au</p>
            </div>
        </div>
    </div>
</div>
