...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div class="p-6">
                    ...
                    @endif
                    <a href="{{ route('appeals.' . str_replace(['appeals-', 'visa-'], '', $relatedPage->slug)) }}" class="text-blue-600 hover:text-blue-800 font-medium">Learn More →</a>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <!-- Call to Action -->
    <div class="mt-16 bg-red-50 rounded-lg p-8 text-center">
        <h3 class="text-2xl font-bold text-gray-800 mb-4">Need Help with Your Visa Appeal?</h3>
        <p class="text-gray-600 mb-6">Time is critical in visa appeals. Contact our experienced team immediately for urgent assistance.</p>
