...
class Page extends Model
{
    ...
    public function generateRouteName()
    {
        ...
        $routeMappings = [
            ...
            'migration' => [
                'temporary-graduate-visa-subclass-485' => 'migration.temporary-graduate',
                'post-study-work-visa-subclass-485' => 'migration.post-study-work',
                'skilled-recognised-graduate-visa-476' => 'migration.skilled-graduate',
                'skilled-independent-visa-subclass-189' => 'migration.skilled-independent',
                'skilled-nominated-visa-subclass-190' => 'migration.skilled-nominated',
                'skilled-regional-visa-subclass-887' => 'migration.skilled-regional',
                'permanent-residence-skilled-regional-visa-subclass-191' => 'migration.pr-skilled-regional',
                'skilled-work-regional-provisional-visa-subclass-491' => 'migration.skilled-work-regional',
                'acs-skill-assessment' => 'migration.acs-assessment',
                'vetassess-skill-assessment' => 'migration.vetassess-assessment',
                'job-ready-program' => 'migration.job-ready-program',
                'ea-skill-assessment' => 'migration.ea-assessment',
                'accountant-skill-assessment' => 'migration.accountant-assessment',
                'nursing-aphara-registration-and-anmac-skill-assessment' => 'migration.nursing-assessment',
                'regional-points' => 'migration.regional-points',
                'english-points' => 'migration.english-points',
            ...
            'employee-sponsored' => [
                'tss-visa-482' => 'employee-sponsored.tss-482',
                'dama' => 'employee-sponsored.dama',
                'skilled-regional-494' => 'employee-sponsored.skilled-regional-494',
                'temporary-activity-408' => 'employee-sponsored.temporary-activity-408',
                'short-stay-400' => 'employee-sponsored.short-stay-400',
                'ens-186-trt' => 'employee-sponsored.ens-186-trt',
                'ens-186-direct' => 'employee-sponsored.ens-186-direct',
                'distinguished-talent-124' => 'employee-sponsored.distinguished-talent-124',
                'distinguished-talent-858' => 'employee-sponsored.distinguished-talent-858',
                'gti' => 'employee-sponsored.gti',
                'gtes' => 'employee-sponsored.gtes',
                'employee-sponsored' => 'employee-sponsored.index',
            ],
            'business-visa' => [
