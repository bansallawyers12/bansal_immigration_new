    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="mt-8 bg-white rounded-lg shadow-lg p-6">
                ...
                <p class="text-gray-700 mb-4">Our experienced migration agents are here to help you navigate your visa application process. Send us your details for personalized assistance.</p>
                
                @include('components.unified-contact-form', [
                    'form_source' => 'default-page-' . $page->slug,
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-2">
                    ...
                    <a href="/study-australia/student-visa-financial-calculator" class="block text-blue-600 hover:text-blue-800 py-1">Student Visa Calculator</a>
                </div>
            </div>
        </div>
    </div>
