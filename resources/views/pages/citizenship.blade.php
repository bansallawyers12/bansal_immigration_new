...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mt-16">
        <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">Related Citizenship Services</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div class="p-6">
                    ...
                    @endif
                    <a href="{{ route('citizenship.' . str_replace(['citizenship-'], '', $relatedPage->slug)) }}" class="text-blue-600 hover:text-blue-800 font-medium">Learn More →</a>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <div class="mt-16 bg-blue-50 rounded-lg p-8 text-center">
        <h3 class="text-2xl font-bold text-gray-800 mb-4">Ready to Become an Australian Citizen?</h3>
        <p class="text-gray-600 mb-6">Let us guide you through your citizenship application process step by step.</p>
        <a href="{{ route('contact') }}" class="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors inline-block font-medium">Start Your Application</a>
    </div>
</div>
@endsection
