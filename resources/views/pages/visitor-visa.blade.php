...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mt-16 bg-white rounded-lg shadow-lg p-8">
        <h3 class="text-2xl font-bold text-gray-900 mb-4">Need Help with Your Visitor Visa Application?</h3>
        <p class="text-gray-600 mb-6">Our experienced migration agents are here to guide you through the process. Send us your details for personalized visitor visa assistance.</p>
    ...
    <div class="mt-8 bg-blue-50 rounded-lg p-8 text-center">
        <h3 class="text-xl font-bold text-gray-800 mb-4">Prefer Direct Contact?</h3>
        <p class="text-gray-600 mb-6">Speak with our visitor visa specialists directly.</p>
