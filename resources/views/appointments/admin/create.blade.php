...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Add a new appointment to the system</p>
        </div>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="preferred_language" id="preferred_language" value="{{ old('preferred_language', 'English') }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="enquiry_type" id="enquiry_type" 
                                ...
                                @foreach($enquiryTypes as $key => $label)
                                    <option value="{{ $key }}" {{ old('enquiry_type') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('enquiry_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <select name="meeting_type" id="meeting_type" 
                                ...
                                <option value="video_call" {{ old('meeting_type') == 'video_call' ? 'selected' : '' }}>Video Call</option>
                                <option value="phone_call" {{ old('meeting_type') == 'phone_call' ? 'selected' : '' }}>Phone Call</option>
                            </select>
                            @error('meeting_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="specific_service" id="specific_service" value="{{ old('specific_service') }}" 
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea name="enquiry_details" id="enquiry_details" rows="4" 
                                      ...
                                      placeholder="Describe the client's enquiry and requirements..." required>{{ old('enquiry_details') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="admin_notes" id="admin_notes" rows="3" 
                                      ...
                                      placeholder="Internal notes for this appointment...">{{ old('admin_notes') }}</textarea>
                            @error('admin_notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
