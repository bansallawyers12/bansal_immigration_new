...
<div class="relative rounded-2xl overflow-hidden mb-12 min-h-96 md:min-h-[28rem] lg:min-h-[32rem] shadow-2xl group">
    @if($heroBgUrl)
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-blue-900/45 via-blue-800/40 to-blue-700/45"></div>
    @else
        ...
        <div class="w-full max-w-4xl mx-auto">
            <div class="space-y-6 md:space-y-8">
                <div class="space-y-4 md:space-y-6">
                    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white drop-shadow-lg">
                        {{ $page->title }}
                    </h1>
                @if($page->excerpt)
                    <p class="text-white/90 text-lg sm:text-xl md:text-2xl leading-relaxed max-w-3xl drop-shadow-md">{{ $page->excerpt }}</p>
                @endif
                </div>
                
                <div class="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4">
                    <a href="#overview" class="group/btn inline-flex items-center justify-center px-6 md:px-8 py-3 md:py-4 bg-white text-blue-700 font-semibold rounded-xl hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-base md:text-lg">
                    ...
                    <a href="#how-to-apply" class="inline-flex items-center justify-center px-6 md:px-8 py-3 md:py-4 bg-white/20 backdrop-blur-sm border border-white/30 text-white font-semibold rounded-xl hover:bg-white/30 transition-all duration-300 text-base md:text-lg">
