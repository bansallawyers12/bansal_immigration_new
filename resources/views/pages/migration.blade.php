...
@section('seoinfo')
    <title>{{ $page->meta_title ?? $page->title }} - Australian Migration Services | Bansal Immigration</title>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3">
            ...
            <div class="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Ready to Migrate to Australia?</h3>
                <p class="text-gray-700 mb-4">Our registered migration agents will assess your eligibility and guide you through the best pathway for your situation.</p>
