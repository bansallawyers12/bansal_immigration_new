...
@section('seoinfo')
    <title>Our Team - Bansal Immigration Consultants</title>
    <meta name="description" content="Meet our experienced team of MARA registered migration agents and immigration consultants at Bansal Immigration Consultants.">
@endsection
...
<div class="container mx-auto px-4 py-12">
    ...
    <!-- Contact CTA -->
    <div class="text-center">
        <h2 class="text-3xl font-bold text-gray-900 mb-4">Ready to Start Your Immigration Journey?</h2>
        <p class="text-lg text-gray-600 mb-8">Let our experienced team guide you through the process.</p>
