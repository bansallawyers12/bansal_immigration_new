...
@section('title', ($page->meta_title ?? $page->title) . ' - Family Visa Services | Bansal Immigration')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3">
            ...
            <div class="mt-8 bg-white rounded-lg shadow-lg p-8">
                <h3 class="text-2xl font-bold text-gray-900 mb-4">Reunite with Your Loved Ones</h3>
                <p class="text-gray-600 mb-6">Our family visa specialists understand the importance of keeping families together. Let us help you navigate the complex family visa process. Send us your details for personalized guidance.</p>
                @include('components.unified-contact-form', [
                    'form_source' => 'family-visa-page',
                    'form_variant' => 'full',
                    'show_phone' => true,
                    'show_subject' => true
                ])
            ...
            <div class="mt-8 bg-gradient-to-r from-pink-500 to-red-500 rounded-lg p-6 text-white">
                <h3 class="text-xl font-semibold mb-2">Prefer Direct Consultation?</h3>
                <p class="mb-4">Book a family consultation or speak with our family visa specialists directly.</p>
